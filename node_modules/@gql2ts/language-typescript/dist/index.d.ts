import { GenerateSubTypeInterface, WrapType, IFromQueryOptions, InputFormatter, QueryNamer, EnumFormatter, InterfaceAndTypeBuilder, InterfaceDeclarationGenerator, TypeJoiner, TypePrinter, NamespaceGenerator, InterfaceNameWithExtensions, EnumTypeBuilder, GenerateDocumentation, ITypeMap } from '@gql2ts/types';
...
export declare const DEFAULT_TYPE_MAP: ITypeMap;
